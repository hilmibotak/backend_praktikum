...
// @Accept json
// @Produce json
// @Param credentials body model.RegisterRequest true "Register credentials (username, password, dan role)"
// @Success 201 {object} model.RegisterResponse "User registered successfully"
// @Failure 400 "Invalid input or Username, password, and role are required"
